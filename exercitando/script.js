/**
 * hsl = Hue, Saturation, lightness -> cor, saturação, brilho
 *  - Este script tem como objetivo pegar uma cor em hexadecimal
 *    e converte-la para o hue(cor) do hsl
 * 
 *  - Com este recurso é possível mudar a cor de fundo do site
 *    alterando a variável --color sem que a paleta de cores 
 *    perca a harmonia
 */
